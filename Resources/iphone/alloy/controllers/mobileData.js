...
function Controller() {
    ...
    $.__views.__alloyId1157 = Alloy.createController("_header", {
        id: "__alloyId1157",
        __parentSymbol: $.__views.mobileData
    });
    $.__views.__alloyId1157.setParent($.__views.mobileData);
    ...
    $.__views.mobileData.add($.__views.__alloyId1158);
    ...
    back ? $.__views.__alloyId1160.addEventListener("click", back) : __defers["$.__views.__alloyId1160!click!back"] = true;
    ...
    $.__views.scrollView.add($.__views.__alloyId1165);
    $.__views.__alloyId1166 = Ti.UI.createView({
        height: "50",
        backgroundColor: "#000000",
        id: "__alloyId1166"
    });
    $.__views.mobileData.add($.__views.__alloyId1166);
    purchase ? $.__views.__alloyId1166.addEventListener("click", purchase) : __defers["$.__views.__alloyId1166!click!purchase"] = true;
    ...
    __defers["$.__views.__alloyId1160!click!back"] && $.__views.__alloyId1160.addEventListener("click", back);
    __defers["$.__views.__alloyId1166!click!purchase"] && $.__views.__alloyId1166.addEventListener("click", purchase);
    _.extend($, exports);
}
