...
function Controller() {
    ...
    $.__views.__alloyId1479 = Alloy.createController("_header", {
        id: "__alloyId1479",
        __parentSymbol: $.__views.panda3
    });
    $.__views.__alloyId1479.setParent($.__views.panda3);
    ...
    $.__views.panda3.add($.__views.__alloyId1480);
    ...
    $.__views.__alloyId1482 = Ti.UI.createImageView({
        backgroundColor: "transparent",
        width: "30",
        height: "30",
        right: "10",
    ...
    back ? $.__views.__alloyId1482.addEventListener("click", back) : __defers["$.__views.__alloyId1482!click!back"] = true;
    ...
    $.__views.panda3.add($.__views.__alloyId1483);
    ...
    $.__views.panda3.add($.__views.__alloyId1486);
    ...
    $.__views.__alloyId1490 = Ti.UI.createImageView({
    ...
    $.__views.pickerContentView.add($.__views.__alloyId1490);
    showPicker ? $.__views.__alloyId1490.addEventListener("click", showPicker) : __defers["$.__views.__alloyId1490!click!showPicker"] = true;
    ...
    __alloyId1491.push($.__views.__alloyId1492);
    $.__views.__alloyId1493 = Ti.UI.createPickerRow({
        title: "Micro SIM",
        id: "__alloyId1493"
    });
    __alloyId1491.push($.__views.__alloyId1493);
    $.__views.__alloyId1494 = Ti.UI.createPickerRow({
        title: "Nano SIM",
        id: "__alloyId1494"
    });
    __alloyId1491.push($.__views.__alloyId1494);
    $.__views.picker.add(__alloyId1491);
    ...
    $.__views.scrollView.add($.__views.__alloyId1495);
    ...
    $.__views.pickerContentView2.add($.__views.__alloyId1497);
    showPicker ? $.__views.__alloyId1497.addEventListener("click", showPicker) : __defers["$.__views.__alloyId1497!click!showPicker"] = true;
    ...
    __alloyId1498.push($.__views.__alloyId1499);
    $.__views.__alloyId1500 = Ti.UI.createPickerRow({
        title: "RM10",
        id: "__alloyId1500"
    });
    __alloyId1498.push($.__views.__alloyId1500);
    $.__views.__alloyId1501 = Ti.UI.createPickerRow({
        title: "RM30",
        id: "__alloyId1501"
    });
    __alloyId1498.push($.__views.__alloyId1501);
    $.__views.__alloyId1502 = Ti.UI.createPickerRow({
        title: "RM50",
        id: "__alloyId1502"
    });
    __alloyId1498.push($.__views.__alloyId1502);
    $.__views.picker2.add(__alloyId1498);
    ...
    $.__views.scrollView.add($.__views.__alloyId1503);
    ...
    $.__views.scrollView.add($.__views.__alloyId1504);
    ...
    $.__views.scrollView.add($.__views.__alloyId1505);
    ...
    $.__views.panda3.add($.__views.__alloyId1506);
    proceed ? $.__views.__alloyId1506.addEventListener("click", proceed) : __defers["$.__views.__alloyId1506!click!proceed"] = true;
    ...
    var simType;
    var topUp;
    __defers["$.__views.__alloyId1482!click!back"] && $.__views.__alloyId1482.addEventListener("click", back);
    __defers["$.__views.simLabel!click!showPicker"] && $.__views.simLabel.addEventListener("click", showPicker);
    __defers["$.__views.__alloyId1490!click!showPicker"] && $.__views.__alloyId1490.addEventListener("click", showPicker);
    ...
    __defers["$.__views.__alloyId1497!click!showPicker"] && $.__views.__alloyId1497.addEventListener("click", showPicker);
    ...
    __defers["$.__views.__alloyId1506!click!proceed"] && $.__views.__alloyId1506.addEventListener("click", proceed);
    _.extend($, exports);
}
