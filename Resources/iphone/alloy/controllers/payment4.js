...
function Controller() {
    ...
    $.__views.__alloyId848 = Alloy.createController("_header", {
        id: "__alloyId848",
        __parentSymbol: $.__views.payment4
    });
    $.__views.__alloyId848.setParent($.__views.payment4);
    ...
    $.__views.payment4.add($.__views.__alloyId849);
    ...
    $.__views.scrollView.add($.__views.__alloyId851);
    ...
    $.__views.scrollView.add($.__views.__alloyId852);
    ...
    $.__views.__alloyId853 = Ti.UI.createButton({
        title: "Done",
        color: "#44C7D6",
        borderColor: "#44C7D6",
        backgroundColor: "white",
    ...
    $.__views.scrollView.add($.__views.__alloyId853);
    done ? $.__views.__alloyId853.addEventListener("click", done) : __defers["$.__views.__alloyId853!click!done"] = true;
    ...
    __defers["$.__views.__alloyId853!click!done"] && $.__views.__alloyId853.addEventListener("click", done);
    _.extend($, exports);
}
