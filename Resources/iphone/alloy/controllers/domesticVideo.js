...
function Controller() {
    ...
    $.__views.__alloyId302 = Alloy.createController("_header", {
        id: "__alloyId302",
        __parentSymbol: $.__views.domesticVideo
    });
    $.__views.__alloyId302.setParent($.__views.domesticVideo);
    ...
    $.__views.domesticVideo.add($.__views.__alloyId303);
    ...
    back ? $.__views.__alloyId305.addEventListener("click", back) : __defers["$.__views.__alloyId305!click!back"] = true;
    ...
    $.__views.domesticVideo.add($.__views.__alloyId306);
    ...
    var __alloyId308 = [];
    $.__views.__alloyId309 = Ti.UI.createTableViewSection({
        id: "__alloyId309"
    });
    ...
    $.__views.__alloyId324 = Ti.UI.createTableViewRow({
        height: "80",
        width: "100%",
        layout: "horizontal",
        separatorColor: "#000",
    ...
    $.__views.__alloyId309.add($.__views.__alloyId324);
    ...
    $.__views.__alloyId331 = Ti.UI.createTableViewRow({
        height: "80",
        width: "100%",
        layout: "horizontal",
        separatorColor: "#000",
    ...
    $.__views.__alloyId338 = Ti.UI.createTableViewRow({
        height: "80",
        width: "100%",
        layout: "horizontal",
        separatorColor: "#000",
    ...
    $.__views.__alloyId309.add($.__views.__alloyId338);
    ...
    $.__views.__alloyId345 = Ti.UI.createTableViewRow({
        height: "80",
        width: "100%",
        layout: "horizontal",
        separatorColor: "#000",
    ...
    $.__views.__alloyId309.add($.__views.__alloyId345);
    ...
    $.__views.__alloyId352 = Ti.UI.createTableViewRow({
        height: "80",
        width: "100%",
        layout: "horizontal",
        separatorColor: "#000",
    ...
    $.__views.__alloyId309.add($.__views.__alloyId352);
    ...
    $.__views.__alloyId309.add($.__views.__alloyId359);
    ...
    _.extend($, $.__views);
    __defers["$.__views.__alloyId305!click!back"] && $.__views.__alloyId305.addEventListener("click", back);
    _.extend($, exports);
}
