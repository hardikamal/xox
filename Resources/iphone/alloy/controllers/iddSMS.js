...
function Controller() {
    ...
    $.__views.__alloyId761 = Alloy.createController("_header", {
        id: "__alloyId761",
        __parentSymbol: $.__views.iddSMS
    });
    $.__views.__alloyId761.setParent($.__views.iddSMS);
    ...
    $.__views.iddSMS.add($.__views.__alloyId762);
    ...
    back ? $.__views.__alloyId764.addEventListener("click", back) : __defers["$.__views.__alloyId764!click!back"] = true;
    ...
    $.__views.iddSMS.add($.__views.__alloyId765);
    ...
    var __alloyId767 = [];
    $.__views.__alloyId768 = Ti.UI.createTableViewSection({
        id: "__alloyId768"
    });
    __alloyId767.push($.__views.__alloyId768);
    $.__views.__alloyId769 = Ti.UI.createTableViewRow({
        height: "80",
        width: "100%",
        layout: "horizontal",
        separatorColor: "#000",
    ...
    $.__views.__alloyId769.add($.__views.__alloyId774);
    ...
    $.__views.__alloyId768.add($.__views.__alloyId776);
    ...
    $.__views.__alloyId768.add($.__views.__alloyId790);
    ...
    $.__views.__alloyId768.add($.__views.__alloyId797);
    ...
    $.__views.__alloyId768.add($.__views.__alloyId804);
    ...
    $.__views.__alloyId768.add($.__views.__alloyId811);
    ...
    $.__views.__alloyId768.add($.__views.__alloyId818);
    ...
    _.extend($, $.__views);
    __defers["$.__views.__alloyId764!click!back"] && $.__views.__alloyId764.addEventListener("click", back);
    _.extend($, exports);
}
