...
function Controller() {
    ...
    $.__views.__alloyId809 = Alloy.createController("_header", {
        id: "__alloyId809",
        __parentSymbol: $.__views.iddSMS
    });
    $.__views.__alloyId809.setParent($.__views.iddSMS);
    ...
    $.__views.iddSMS.add($.__views.__alloyId810);
    ...
    $.__views.__alloyId812 = Ti.UI.createImageView({
        backgroundColor: "transparent",
        width: "30",
        height: "30",
        right: "10",
    ...
    $.__views.__alloyId810.add($.__views.__alloyId812);
    back ? $.__views.__alloyId812.addEventListener("click", back) : __defers["$.__views.__alloyId812!click!back"] = true;
    ...
    $.__views.iddSMS.add($.__views.__alloyId813);
    ...
    var __alloyId815 = [];
    $.__views.__alloyId816 = Ti.UI.createTableViewSection({
        id: "__alloyId816"
    });
    __alloyId815.push($.__views.__alloyId816);
    $.__views.__alloyId817 = Ti.UI.createTableViewRow({
        height: "80",
        width: "100%",
        layout: "horizontal",
        separatorColor: "#000",
    ...
    $.__views.__alloyId817.add($.__views.__alloyId822);
    ...
    $.__views.__alloyId824 = Ti.UI.createTableViewRow({
        height: "80",
        width: "100%",
        layout: "horizontal",
        separatorColor: "#000",
    ...
    $.__views.__alloyId816.add($.__views.__alloyId824);
    ...
    $.__views.__alloyId824.add($.__views.__alloyId829);
    ...
    $.__views.__alloyId831 = Ti.UI.createTableViewRow({
        height: "80",
        width: "100%",
        layout: "horizontal",
        separatorColor: "#000",
    ...
    $.__views.__alloyId816.add($.__views.__alloyId831);
    ...
    $.__views.__alloyId831.add($.__views.__alloyId834);
    ...
    $.__views.__alloyId831.add($.__views.__alloyId836);
    ...
    $.__views.__alloyId838 = Ti.UI.createTableViewRow({
        height: "80",
        width: "100%",
        layout: "horizontal",
        separatorColor: "#000",
    ...
    $.__views.__alloyId816.add($.__views.__alloyId838);
    ...
    $.__views.__alloyId845 = Ti.UI.createTableViewRow({
        height: "80",
        width: "100%",
        layout: "horizontal",
        separatorColor: "#000",
    ...
    $.__views.__alloyId816.add($.__views.__alloyId845);
    ...
    $.__views.__alloyId845.add($.__views.__alloyId850);
    ...
    $.__views.__alloyId852 = Ti.UI.createTableViewRow({
        height: "80",
        width: "100%",
        layout: "horizontal",
        separatorColor: "#000",
    ...
    $.__views.__alloyId816.add($.__views.__alloyId852);
    ...
    $.__views.__alloyId852.add($.__views.__alloyId857);
    ...
    $.__views.__alloyId859 = Ti.UI.createTableViewRow({
        height: "80",
        width: "100%",
        layout: "horizontal",
        separatorColor: "#000",
    ...
    $.__views.__alloyId816.add($.__views.__alloyId859);
    ...
    $.__views.__alloyId859.add($.__views.__alloyId864);
    ...
    $.__views.__alloyId866 = Ti.UI.createTableViewRow({
        height: "80",
        width: "100%",
        layout: "horizontal",
        separatorColor: "#000",
    ...
    $.__views.__alloyId816.add($.__views.__alloyId866);
    ...
    $.__views.__alloyId866.add($.__views.__alloyId871);
    ...
    _.extend($, $.__views);
    __defers["$.__views.__alloyId812!click!back"] && $.__views.__alloyId812.addEventListener("click", back);
    _.extend($, exports);
}
