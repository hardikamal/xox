...
function Controller() {
    ...
    $.__views.scrollView.add($.__views.__alloyId2715);
    $.__views.__alloyId2716 = Ti.UI.createLabel({
        text: "Mobile Number",
        width: "45%",
        left: "5%",
        height: "100%",
    ...
    $.__views.__alloyId2715.add($.__views.__alloyId2717);
    ...
    $.__views.scrollView.add($.__views.__alloyId2742);
