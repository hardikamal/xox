...
function Controller() {
    ...
    $.__views.scrollView.add($.__views.__alloyId1670);
    ...
    $.__views.scrollView.add($.__views.__alloyId1671);
    ...
    $.__views.scrollView.add($.__views.__alloyId1674);
    ...
    $.__views.penang3.add($.__views.__alloyId1675);
    purchase ? $.__views.__alloyId1675.addEventListener("click", purchase) : __defers["$.__views.__alloyId1675!click!purchase"] = true;
    ...
    __defers["$.__views.__alloyId1675!click!purchase"] && $.__views.__alloyId1675.addEventListener("click", purchase);
    _.extend($, exports);
}
