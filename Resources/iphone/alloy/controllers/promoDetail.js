...
function Controller() {
    ...
    $.__views.__alloyId2196 = Alloy.createController("_header", {
        id: "__alloyId2196",
        __parentSymbol: $.__views.promoDetail
    });
    $.__views.__alloyId2196.setParent($.__views.promoDetail);
    ...
    $.__views.promoDetail.add($.__views.__alloyId2197);
    $.__views.__alloyId2198 = Ti.UI.createImageView({
    ...
    back ? $.__views.__alloyId2198.addEventListener("click", back) : __defers["$.__views.__alloyId2198!click!back"] = true;
    ...
    $.__views.__alloyId2197.add($.__views.__alloyId2199);
    $.__views.__alloyId2200 = Ti.UI.createScrollView({
        layout: "vertical",
    ...
    $.__views.__alloyId2197.add($.__views.__alloyId2200);
    ...
    $.__views.__alloyId2202 = Ti.UI.createButton({
        title: "Buy Now",
        color: "#44C7D6",
        borderColor: "#44C7D6",
        backgroundColor: "white",
    ...
    buy ? $.__views.__alloyId2202.addEventListener("click", buy) : __defers["$.__views.__alloyId2202!click!buy"] = true;
    ...
    $.__views.promoDetail.add($.__views.__alloyId2203);
    ...
    $.__views.__alloyId2203.add($.__views.__alloyId2207);
    ...
    $.__views.__alloyId2203.add($.__views.__alloyId2210);
    exports.destroy = function() {};
    _.extend($, $.__views);
    __defers["$.__views.__alloyId2198!click!back"] && $.__views.__alloyId2198.addEventListener("click", back);
    __defers["$.__views.__alloyId2202!click!buy"] && $.__views.__alloyId2202.addEventListener("click", buy);
    _.extend($, exports);
}
