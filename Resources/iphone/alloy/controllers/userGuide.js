...
function Controller() {
    ...
    $.__views.__alloyId1582 = Alloy.createController("_header", {
        id: "__alloyId1582",
        __parentSymbol: $.__views.userGuide
    });
    $.__views.__alloyId1582.setParent($.__views.userGuide);
    $.__views.__alloyId1583 = Ti.UI.createView({
        height: "20%",
        backgroundColor: "#AFCD3F",
        id: "__alloyId1583"
    });
    $.__views.userGuide.add($.__views.__alloyId1583);
    ...
    $.__views.pickerContentView.add($.__views.__alloyId1586);
    showPicker ? $.__views.__alloyId1586.addEventListener("click", showPicker) : __defers["$.__views.__alloyId1586!click!showPicker"] = true;
    ...
    __alloyId1587.push($.__views.__alloyId1588);
    $.__views.__alloyId1589 = Ti.UI.createPickerRow({
        title: "Selangor",
        id: "__alloyId1589"
    });
    __alloyId1587.push($.__views.__alloyId1589);
    $.__views.__alloyId1590 = Ti.UI.createPickerRow({
        title: "Kuala Lumpur",
        id: "__alloyId1590"
    });
    __alloyId1587.push($.__views.__alloyId1590);
    $.__views.__alloyId1591 = Ti.UI.createPickerRow({
        title: "Johor",
        id: "__alloyId1591"
    });
    __alloyId1587.push($.__views.__alloyId1591);
    $.__views.picker.add(__alloyId1587);
    guide ? $.__views.picker.addEventListener("change", guide) : __defers["$.__views.picker!change!guide"] = true;
    $.__views.__alloyId1592 = Ti.UI.createScrollView({
        layout: "vertical",
        backgroundColor: "white",
        id: "__alloyId1592"
    });
    $.__views.userGuide.add($.__views.__alloyId1592);
    ...
    $.__views.__alloyId1592.add($.__views.label);
    exports.destroy = function() {};
    _.extend($, $.__views);
    var guide;
    $.picker.setSelectedRow(0, 0, false);
    __defers["$.__views.guideLabel!click!showPicker"] && $.__views.guideLabel.addEventListener("click", showPicker);
    __defers["$.__views.__alloyId1586!click!showPicker"] && $.__views.__alloyId1586.addEventListener("click", showPicker);
