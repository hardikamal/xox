...
function Controller() {
    ...
    $.__views.__alloyId1224 = Alloy.createController("_header", {
        id: "__alloyId1224",
        __parentSymbol: $.__views.userGuide
    });
    $.__views.__alloyId1224.setParent($.__views.userGuide);
    $.__views.__alloyId1225 = Ti.UI.createView({
        height: "20%",
        backgroundColor: "#AFCD3F",
        id: "__alloyId1225"
    });
    $.__views.userGuide.add($.__views.__alloyId1225);
    ...
    $.__views.contentView.add($.__views.__alloyId1227);
    ...
    $.__views.__alloyId1228 = Ti.UI.createImageView({
    ...
    $.__views.pickerContentView.add($.__views.__alloyId1228);
    showPicker ? $.__views.__alloyId1228.addEventListener("click", showPicker) : __defers["$.__views.__alloyId1228!click!showPicker"] = true;
    ...
    __alloyId1229.push($.__views.__alloyId1230);
    $.__views.__alloyId1231 = Ti.UI.createPickerRow({
        title: "Selangor",
        id: "__alloyId1231"
    });
    __alloyId1229.push($.__views.__alloyId1231);
    $.__views.__alloyId1232 = Ti.UI.createPickerRow({
        title: "Kuala Lumpur",
        id: "__alloyId1232"
    });
    __alloyId1229.push($.__views.__alloyId1232);
    $.__views.__alloyId1233 = Ti.UI.createPickerRow({
        title: "Johor",
        id: "__alloyId1233"
    });
    __alloyId1229.push($.__views.__alloyId1233);
    $.__views.picker.add(__alloyId1229);
    guide ? $.__views.picker.addEventListener("change", guide) : __defers["$.__views.picker!change!guide"] = true;
    $.__views.__alloyId1234 = Ti.UI.createScrollView({
        layout: "vertical",
        backgroundColor: "white",
        id: "__alloyId1234"
    });
    $.__views.userGuide.add($.__views.__alloyId1234);
    ...
    $.__views.__alloyId1234.add($.__views.label);
    exports.destroy = function() {};
    _.extend($, $.__views);
    var guide;
    $.picker.setSelectedRow(0, 0, false);
    __defers["$.__views.guideLabel!click!showPicker"] && $.__views.guideLabel.addEventListener("click", showPicker);
    __defers["$.__views.__alloyId1228!click!showPicker"] && $.__views.__alloyId1228.addEventListener("click", showPicker);
