...
function Controller() {
    ...
    $.__views.__alloyId174 = Alloy.createController("_header", {
        id: "__alloyId174",
        __parentSymbol: $.__views.domesticCallStatement
    });
    $.__views.__alloyId174.setParent($.__views.domesticCallStatement);
    ...
    $.__views.domesticCallStatement.add($.__views.__alloyId175);
    ...
    back ? $.__views.__alloyId177.addEventListener("click", back) : __defers["$.__views.__alloyId177!click!back"] = true;
    ...
    $.__views.domesticCallStatement.add($.__views.__alloyId178);
    ...
    var __alloyId180 = [];
    $.__views.__alloyId181 = Ti.UI.createTableViewSection({
        id: "__alloyId181"
    });
    ...
    $.__views.__alloyId181.add($.__views.__alloyId210);
    ...
    $.__views.__alloyId181.add($.__views.__alloyId217);
    ...
    $.__views.__alloyId181.add($.__views.__alloyId224);
    ...
    $.__views.__alloyId181.add($.__views.__alloyId231);
    ...
    _.extend($, $.__views);
    __defers["$.__views.__alloyId177!click!back"] && $.__views.__alloyId177.addEventListener("click", back);
    _.extend($, exports);
}
