...
function Controller() {
    ...
    $.__views.__alloyId412 = Alloy.createController("_header", {
        id: "__alloyId412",
        __parentSymbol: $.__views.familyFriend
    });
    $.__views.__alloyId412.setParent($.__views.familyFriend);
    ...
    $.__views.add.add($.__views.__alloyId413);
    ...
    $.__views.__alloyId416.add($.__views.mobileNo);
    ...
    submit ? $.__views.__alloyId418.addEventListener("click", submit) : __defers["$.__views.__alloyId418!click!submit"] = true;
    ...
    cancel ? $.__views.__alloyId421.addEventListener("click", cancel) : __defers["$.__views.__alloyId421!click!cancel"] = true;
    ...
    $.__views.familyFriend.add($.__views.__alloyId423);
    ...
    $.__views.__alloyId423.add($.__views.scrollView);
    ...
    $.__views.__alloyId429.add($.__views.__alloyId433);
    ...
    $.__views.scrollView.add($.__views.__alloyId434);
    $.__views.__alloyId435 = Ti.UI.createView({
        height: "50",
        backgroundColor: "black",
        id: "__alloyId435"
    });
    $.__views.__alloyId423.add($.__views.__alloyId435);
    ff ? $.__views.__alloyId435.addEventListener("click", ff) : __defers["$.__views.__alloyId435!click!ff"] = true;
    ...
    __defers["$.__views.__alloyId418!click!submit"] && $.__views.__alloyId418.addEventListener("click", submit);
    __defers["$.__views.__alloyId421!click!cancel"] && $.__views.__alloyId421.addEventListener("click", cancel);
    __defers["$.__views.__alloyId426!click!back"] && $.__views.__alloyId426.addEventListener("click", back);
    __defers["$.__views.__alloyId435!click!ff"] && $.__views.__alloyId435.addEventListener("click", ff);
    _.extend($, exports);
}
