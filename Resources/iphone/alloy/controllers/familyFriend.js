...
function Controller() {
    ...
    $.__views.__alloyId366.setParent($.__views.familyFriend);
    ...
    $.__views.add.add($.__views.__alloyId367);
    ...
    $.__views.__alloyId370.add($.__views.mobileNo);
    ...
    submit ? $.__views.__alloyId372.addEventListener("click", submit) : __defers["$.__views.__alloyId372!click!submit"] = true;
    ...
    cancel ? $.__views.__alloyId375.addEventListener("click", cancel) : __defers["$.__views.__alloyId375!click!cancel"] = true;
    ...
    $.__views.familyFriend.add($.__views.__alloyId377);
    ...
    back ? $.__views.__alloyId380.addEventListener("click", back) : __defers["$.__views.__alloyId380!click!back"] = true;
    ...
    $.__views.__alloyId377.add($.__views.__alloyId381);
    ...
    $.__views.__alloyId377.add($.__views.scrollView);
    ...
    $.__views.scrollView.add($.__views.__alloyId388);
    ...
    ff ? $.__views.__alloyId389.addEventListener("click", ff) : __defers["$.__views.__alloyId389!click!ff"] = true;
    ...
    __defers["$.__views.__alloyId372!click!submit"] && $.__views.__alloyId372.addEventListener("click", submit);
    __defers["$.__views.__alloyId375!click!cancel"] && $.__views.__alloyId375.addEventListener("click", cancel);
    __defers["$.__views.__alloyId380!click!back"] && $.__views.__alloyId380.addEventListener("click", back);
    __defers["$.__views.__alloyId389!click!ff"] && $.__views.__alloyId389.addEventListener("click", ff);
    _.extend($, exports);
}
