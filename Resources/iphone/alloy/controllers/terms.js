...
function Controller() {
    ...
    $.__views.__alloyId1213 = Alloy.createController("_header", {
        id: "__alloyId1213",
        __parentSymbol: $.__views.terms
    });
    $.__views.__alloyId1213.setParent($.__views.terms);
    $.__views.__alloyId1214 = Ti.UI.createView({
        height: "20%",
        backgroundColor: "#AFCD3F",
        id: "__alloyId1214"
    });
    $.__views.terms.add($.__views.__alloyId1214);
    ...
    $.__views.contentView.add($.__views.__alloyId1216);
    ...
    $.__views.pickerContentView.add($.__views.__alloyId1217);
    showPicker ? $.__views.__alloyId1217.addEventListener("click", showPicker) : __defers["$.__views.__alloyId1217!click!showPicker"] = true;
    ...
    __alloyId1218.push($.__views.__alloyId1219);
    $.__views.__alloyId1220 = Ti.UI.createPickerRow({
        title: "Selangor",
        id: "__alloyId1220"
    });
    __alloyId1218.push($.__views.__alloyId1220);
    $.__views.__alloyId1221 = Ti.UI.createPickerRow({
        title: "Kuala Lumpur",
        id: "__alloyId1221"
    });
    __alloyId1218.push($.__views.__alloyId1221);
    $.__views.__alloyId1222 = Ti.UI.createPickerRow({
        title: "Johor",
        id: "__alloyId1222"
    });
    __alloyId1218.push($.__views.__alloyId1222);
    $.__views.picker.add(__alloyId1218);
    terms ? $.__views.picker.addEventListener("change", terms) : __defers["$.__views.picker!change!terms"] = true;
    $.__views.__alloyId1223 = Ti.UI.createScrollView({
        layout: "vertical",
        backgroundColor: "white",
        id: "__alloyId1223"
    });
    $.__views.terms.add($.__views.__alloyId1223);
    ...
    $.__views.__alloyId1223.add($.__views.title);
    ...
    $.__views.__alloyId1223.add($.__views.label);
    exports.destroy = function() {};
    _.extend($, $.__views);
    var terms;
    $.picker.setSelectedRow(0, 0, false);
    __defers["$.__views.termLabel!click!showPicker"] && $.__views.termLabel.addEventListener("click", showPicker);
    __defers["$.__views.__alloyId1217!click!showPicker"] && $.__views.__alloyId1217.addEventListener("click", showPicker);
