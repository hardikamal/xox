...
function Controller() {
    ...
    $.__views.__alloyId384 = Alloy.createController("_header", {
        id: "__alloyId384",
        __parentSymbol: $.__views.hopOn4
    });
    $.__views.__alloyId384.setParent($.__views.hopOn4);
    ...
    $.__views.hopOn4.add($.__views.__alloyId385);
    ...
    back ? $.__views.__alloyId387.addEventListener("click", back) : __defers["$.__views.__alloyId387!click!back"] = true;
    ...
    $.__views.hopOn4.add($.__views.__alloyId388);
    ...
    $.__views.scrollView.add($.__views.__alloyId391);
    ...
    $.__views.__alloyId391.add($.__views.item_title);
    ...
    $.__views.__alloyId391.add($.__views.desc_title);
    ...
    $.__views.__alloyId391.add($.__views.cost_title);
    ...
    $.__views.scrollView.add($.__views.__alloyId392);
    ...
    $.__views.__alloyId392.add($.__views.item_data);
    ...
    $.__views.__alloyId392.add($.__views.desc_data);
    ...
    $.__views.__alloyId392.add($.__views.cost_data);
    ...
    $.__views.__alloyId393.add($.__views.total_payment);
    ...
    $.__views.__alloyId393.add($.__views.total_price);
    $.__views.__alloyId394 = Ti.UI.createView({
        height: "50",
        backgroundColor: "red",
        id: "__alloyId394"
    });
    $.__views.hopOn4.add($.__views.__alloyId394);
    submit ? $.__views.__alloyId394.addEventListener("click", submit) : __defers["$.__views.__alloyId394!click!submit"] = true;
    ...
    __defers["$.__views.__alloyId387!click!back"] && $.__views.__alloyId387.addEventListener("click", back);
    __defers["$.__views.__alloyId394!click!submit"] && $.__views.__alloyId394.addEventListener("click", submit);
    _.extend($, exports);
}
