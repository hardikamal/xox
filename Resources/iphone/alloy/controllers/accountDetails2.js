...
function Controller() {
    ...
    $.__views.__alloyId74.setParent($.__views.accountDetails2);
    ...
    $.__views.scrollView.add($.__views.__alloyId82);
    ...
    $.__views.scrollView.add($.__views.__alloyId83);
    ...
    postpaidStatement ? $.__views.__alloyId84.addEventListener("click", postpaidStatement) : __defers["$.__views.__alloyId84!click!postpaidStatement"] = true;
    ...
    postpaidStatement ? $.__views.__alloyId86.addEventListener("click", postpaidStatement) : __defers["$.__views.__alloyId86!click!postpaidStatement"] = true;
    ...
    $.__views.__alloyId86.add($.__views.arrow2);
    ...
    __defers["$.__views.__alloyId84!click!postpaidStatement"] && $.__views.__alloyId84.addEventListener("click", postpaidStatement);
    __defers["$.__views.__alloyId86!click!postpaidStatement"] && $.__views.__alloyId86.addEventListener("click", postpaidStatement);
    _.extend($, exports);
}
