...
function Controller() {
    ...
    malaysia ? $.__views.__alloyId97.addEventListener("click", malaysia) : __defers["$.__views.__alloyId97!click!malaysia"] = true;
    ...
    mobile ? $.__views.__alloyId102.addEventListener("click", mobile) : __defers["$.__views.__alloyId102!click!mobile"] = true;
    ...
    __alloyId96.push($.__views.__alloyId107);
    abroad ? $.__views.__alloyId107.addEventListener("click", abroad) : __defers["$.__views.__alloyId107!click!abroad"] = true;
    ...
    __alloyId96.push($.__views.__alloyId112);
    ...
    __alloyId96.push($.__views.__alloyId117);
    ...
    __defers["$.__views.__alloyId97!click!malaysia"] && $.__views.__alloyId97.addEventListener("click", malaysia);
    __defers["$.__views.__alloyId102!click!mobile"] && $.__views.__alloyId102.addEventListener("click", mobile);
    __defers["$.__views.__alloyId107!click!abroad"] && $.__views.__alloyId107.addEventListener("click", abroad);
    _.extend($, exports);
}
