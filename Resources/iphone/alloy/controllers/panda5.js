...
function Controller() {
    ...
    $.__views.__alloyId1523 = Alloy.createController("_header", {
        id: "__alloyId1523",
        __parentSymbol: $.__views.panda5
    });
    $.__views.__alloyId1523.setParent($.__views.panda5);
    ...
    $.__views.panda5.add($.__views.__alloyId1524);
    ...
    $.__views.__alloyId1524.add($.__views.__alloyId1526);
    back ? $.__views.__alloyId1526.addEventListener("click", back) : __defers["$.__views.__alloyId1526!click!back"] = true;
    ...
    $.__views.panda5.add($.__views.__alloyId1527);
    ...
    $.__views.panda5.add($.__views.__alloyId1531);
    download ? $.__views.__alloyId1531.addEventListener("click", download) : __defers["$.__views.__alloyId1531!click!download"] = true;
    ...
    __defers["$.__views.__alloyId1526!click!back"] && $.__views.__alloyId1526.addEventListener("click", back);
    __defers["$.__views.__alloyId1531!click!download"] && $.__views.__alloyId1531.addEventListener("click", download);
    _.extend($, exports);
}
