...
function Controller() {
    ...
    $.__views.__alloyId854 = Alloy.createController("_header", {
        id: "__alloyId854",
        __parentSymbol: $.__views.penang
    });
    $.__views.__alloyId854.setParent($.__views.penang);
    ...
    $.__views.penang.add($.__views.__alloyId855);
    ...
    $.__views.__alloyId857 = Ti.UI.createImageView({
        backgroundColor: "transparent",
        width: "30",
        height: "30",
        right: "10",
    ...
    $.__views.__alloyId855.add($.__views.__alloyId857);
    back ? $.__views.__alloyId857.addEventListener("click", back) : __defers["$.__views.__alloyId857!click!back"] = true;
    ...
    $.__views.scrollView.add($.__views.__alloyId858);
    ...
    $.__views.__alloyId867.add($.__views.__alloyId869);
    ...
    $.__views.__alloyId864.add($.__views.__alloyId870);
    ...
    $.__views.__alloyId864.add($.__views.__alloyId876);
    ...
    $.__views.scrollView.add($.__views.__alloyId879);
    ...
    $.__views.__alloyId879.add($.__views.__alloyId885);
    ...
    $.__views.penang.add($.__views.__alloyId888);
    subscribe ? $.__views.__alloyId888.addEventListener("click", subscribe) : __defers["$.__views.__alloyId888!click!subscribe"] = true;
    ...
    __defers["$.__views.__alloyId857!click!back"] && $.__views.__alloyId857.addEventListener("click", back);
    __defers["$.__views.__alloyId888!click!subscribe"] && $.__views.__alloyId888.addEventListener("click", subscribe);
    _.extend($, exports);
}
