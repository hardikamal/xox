...
function Controller() {
    ...
    $.__views.__alloyId889 = Alloy.createController("_header", {
        id: "__alloyId889",
        __parentSymbol: $.__views.iddVoice
    });
    $.__views.__alloyId889.setParent($.__views.iddVoice);
    ...
    $.__views.iddVoice.add($.__views.__alloyId890);
    ...
    $.__views.__alloyId892 = Ti.UI.createImageView({
        backgroundColor: "transparent",
        width: "30",
        height: "30",
        right: "10",
    ...
    $.__views.__alloyId890.add($.__views.__alloyId892);
    back ? $.__views.__alloyId892.addEventListener("click", back) : __defers["$.__views.__alloyId892!click!back"] = true;
    ...
    $.__views.iddVoice.add($.__views.__alloyId893);
    ...
    var __alloyId895 = [];
    $.__views.__alloyId896 = Ti.UI.createTableViewSection({
        id: "__alloyId896"
    });
    ...
    $.__views.__alloyId896.add($.__views.__alloyId904);
    ...
    $.__views.__alloyId896.add($.__views.__alloyId911);
    ...
    $.__views.__alloyId896.add($.__views.__alloyId918);
    ...
    $.__views.__alloyId896.add($.__views.__alloyId925);
    ...
    $.__views.__alloyId896.add($.__views.__alloyId932);
    ...
    $.__views.__alloyId896.add($.__views.__alloyId939);
    ...
    $.__views.__alloyId896.add($.__views.__alloyId946);
    ...
    _.extend($, $.__views);
    __defers["$.__views.__alloyId892!click!back"] && $.__views.__alloyId892.addEventListener("click", back);
    _.extend($, exports);
}
