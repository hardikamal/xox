...
function Controller() {
    ...
    $.__views.scrollView.add($.__views.__alloyId2681);
    ...
    $.__views.__alloyId2684 = Ti.UI.createLabel({
    ...
    $.__views.__alloyId2683.add($.__views.__alloyId2685);
    $.__views.__alloyId2686 = Ti.UI.createView({
        layout: "horizontal",
        width: "25%",
        id: "__alloyId2686"
    });
    $.__views.__alloyId2683.add($.__views.__alloyId2686);
    $.__views.__alloyId2687 = Ti.UI.createLabel({
        text: "Top up",
        height: "100%",
        backgroundColor: "transparent",
        color: "black",
    ...
    $.__views.__alloyId2686.add($.__views.arrow1);
    ...
    $.__views.scrollView.add($.__views.__alloyId2689);
    $.__views.__alloyId2690 = Ti.UI.createLabel({
        text: "Expiry Date",
        width: "45%",
        left: "5%",
        height: "100%",
    ...
    $.__views.__alloyId2689.add($.__views.__alloyId2691);
    ...
    $.__views.scrollView.add($.__views.__alloyId2692);
    ...
    $.__views.__alloyId2693.add($.__views.__alloyId2695);
    ...
    $.__views.__alloyId2699 = Ti.UI.createLabel({
    ...
    $.__views.__alloyId2700 = Ti.UI.createView({
        layout: "horizontal",
        height: "50",
        id: "__alloyId2700"
    });
    $.__views.scrollView.add($.__views.__alloyId2700);
    ...
    $.__views.__alloyId2700.add($.__views.__alloyId2701);
    $.__views.__alloyId2702 = Ti.UI.createLabel({
        text: "0",
        width: "50%",
        height: "100%",
        backgroundColor: "transparent",
    ...
    $.__views.__alloyId2700.add($.__views.__alloyId2702);
    ...
    $.__views.scrollView.add($.__views.__alloyId2704);
    ...
    $.__views.__alloyId2706 = Ti.UI.createLabel({
        text: "0",
        width: "50%",
        height: "100%",
        backgroundColor: "transparent",
    ...
    $.__views.__alloyId2704.add($.__views.__alloyId2706);
    ...
    $.__views.scrollView.add($.__views.__alloyId2707);
    ...
    $.__views.scrollView.add($.__views.__alloyId2711);
    ...
    $.__views.scrollView.add($.__views.__alloyId2713);
    ...
    $.__views.__alloyId2713.add($.__views.__alloyId2715);
    ...
    $.__views.sublineDetails1.add($.__views.__alloyId2716);
    download ? $.__views.__alloyId2716.addEventListener("click", download) : __defers["$.__views.__alloyId2716!click!download"] = true;
    ...
    __defers["$.__views.__alloyId2716!click!download"] && $.__views.__alloyId2716.addEventListener("click", download);
    _.extend($, exports);
}
