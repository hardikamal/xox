...
function Controller() {
    ...
    $.__views.__alloyId873 = Alloy.createController("_header", {
        id: "__alloyId873",
        __parentSymbol: $.__views.iddVideo
    });
    $.__views.__alloyId873.setParent($.__views.iddVideo);
    ...
    $.__views.iddVideo.add($.__views.__alloyId874);
    ...
    $.__views.__alloyId876 = Ti.UI.createImageView({
        backgroundColor: "transparent",
        width: "30",
        height: "30",
        right: "10",
    ...
    back ? $.__views.__alloyId876.addEventListener("click", back) : __defers["$.__views.__alloyId876!click!back"] = true;
    ...
    $.__views.iddVideo.add($.__views.__alloyId877);
    ...
    var __alloyId879 = [];
    $.__views.__alloyId880 = Ti.UI.createTableViewSection({
        id: "__alloyId880"
    });
    __alloyId879.push($.__views.__alloyId880);
    $.__views.__alloyId881 = Ti.UI.createTableViewRow({
        height: "80",
        width: "100%",
        layout: "horizontal",
        separatorColor: "#000",
    ...
    $.__views.__alloyId881.add($.__views.__alloyId886);
    ...
    $.__views.__alloyId888 = Ti.UI.createTableViewRow({
        height: "80",
        width: "100%",
        layout: "horizontal",
        separatorColor: "#000",
    ...
    $.__views.__alloyId880.add($.__views.__alloyId888);
    ...
    $.__views.__alloyId895 = Ti.UI.createTableViewRow({
        height: "80",
        width: "100%",
        layout: "horizontal",
        separatorColor: "#000",
    ...
    $.__views.__alloyId880.add($.__views.__alloyId895);
    ...
    $.__views.__alloyId895.add($.__views.__alloyId898);
    ...
    $.__views.__alloyId895.add($.__views.__alloyId900);
    ...
    $.__views.__alloyId902 = Ti.UI.createTableViewRow({
        height: "80",
        width: "100%",
        layout: "horizontal",
        separatorColor: "#000",
    ...
    $.__views.__alloyId880.add($.__views.__alloyId902);
    ...
    $.__views.__alloyId902.add($.__views.__alloyId905);
    ...
    $.__views.__alloyId902.add($.__views.__alloyId907);
    ...
    $.__views.__alloyId909 = Ti.UI.createTableViewRow({
        height: "80",
        width: "100%",
        layout: "horizontal",
        separatorColor: "#000",
    ...
    $.__views.__alloyId880.add($.__views.__alloyId909);
    ...
    $.__views.__alloyId909.add($.__views.__alloyId914);
    ...
    $.__views.__alloyId916 = Ti.UI.createTableViewRow({
        height: "80",
        width: "100%",
        layout: "horizontal",
        separatorColor: "#000",
    ...
    $.__views.__alloyId880.add($.__views.__alloyId916);
    ...
    $.__views.__alloyId916.add($.__views.__alloyId921);
    ...
    $.__views.__alloyId923 = Ti.UI.createTableViewRow({
        height: "80",
        width: "100%",
        layout: "horizontal",
        separatorColor: "#000",
    ...
    $.__views.__alloyId880.add($.__views.__alloyId923);
    ...
    $.__views.__alloyId923.add($.__views.__alloyId928);
    ...
    $.__views.__alloyId930 = Ti.UI.createTableViewRow({
        height: "80",
        width: "100%",
        layout: "horizontal",
        separatorColor: "#000",
    ...
    $.__views.__alloyId880.add($.__views.__alloyId930);
    ...
    $.__views.__alloyId930.add($.__views.__alloyId933);
    ...
    $.__views.__alloyId930.add($.__views.__alloyId935);
    ...
    _.extend($, $.__views);
    __defers["$.__views.__alloyId876!click!back"] && $.__views.__alloyId876.addEventListener("click", back);
    _.extend($, exports);
}
