...
<<<<<<< Updated upstream
    ...
    $.__views.__alloyId440.setParent($.__views.faq);
...
<<<<<<< Updated upstream
    ...
    back ? $.__views.__alloyId443.addEventListener("click", back) : __defers["$.__views.__alloyId443!click!back"] = true;
    $.__views.__alloyId444 = Ti.UI.createScrollView({
        layout: "vertical",
...
<<<<<<< Updated upstream
    ...
    $.__views.row1.add($.__views.__alloyId445);
...
<<<<<<< Updated upstream
    ...
    $.__views.row2.add($.__views.__alloyId454);
...
<<<<<<< Updated upstream
    ...
    $.__views.row3.add($.__views.__alloyId463);
...
<<<<<<< Updated upstream
    ...
    $.__views.row4.add($.__views.__alloyId472);
...
<<<<<<< Updated upstream
    ...
    $.__views.row5.add($.__views.__alloyId481);
