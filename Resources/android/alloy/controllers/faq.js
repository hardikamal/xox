...
function Controller() {
    ...
    $.__views.__alloyId439 = Alloy.createController("_header", {
        id: "__alloyId439",
        __parentSymbol: $.__views.faq
    });
    $.__views.__alloyId439.setParent($.__views.faq);
    ...
    $.__views.faq.add($.__views.__alloyId440);
    ...
    back ? $.__views.__alloyId442.addEventListener("click", back) : __defers["$.__views.__alloyId442!click!back"] = true;
    $.__views.__alloyId443 = Ti.UI.createScrollView({
        layout: "vertical",
        backgroundColor: "#E6E7E9",
        id: "__alloyId443"
    });
    $.__views.faq.add($.__views.__alloyId443);
    ...
    $.__views.__alloyId443.add($.__views.row1);
    ...
    $.__views.row1.add($.__views.__alloyId444);
    ...
    $.__views.row1.add($.__views.__alloyId451);
    ...
    $.__views.__alloyId443.add($.__views.row2);
    ...
    $.__views.row2.add($.__views.__alloyId453);
    ...
    $.__views.row2.add($.__views.__alloyId460);
    ...
    $.__views.__alloyId443.add($.__views.row3);
    ...
    $.__views.row3.add($.__views.__alloyId462);
    ...
    $.__views.__alloyId462.add($.__views.__alloyId466);
    ...
    $.__views.row3.add($.__views.__alloyId469);
    ...
    $.__views.__alloyId443.add($.__views.row4);
    ...
    $.__views.row4.add($.__views.__alloyId471);
    ...
    $.__views.__alloyId471.add($.__views.__alloyId475);
    $.__views.__alloyId476 = Ti.UI.createImageView({
        image: "/images/dropdown_icon.png",
        width: "25",
        height: "15",
        right: "10",
    ...
    $.__views.row4.add($.__views.__alloyId478);
    ...
    $.__views.__alloyId443.add($.__views.row5);
    ...
    $.__views.row5.add($.__views.__alloyId480);
    ...
    $.__views.row5.add($.__views.__alloyId487);
    ...
    _.extend($, $.__views);
    __defers["$.__views.__alloyId442!click!back"] && $.__views.__alloyId442.addEventListener("click", back);
