...
function Controller() {
    ...
    $.__views.__alloyId704.setParent($.__views.idd);
    ...
    $.__views.idd.add($.__views.__alloyId705);
    ...
    $.__views.idd.add($.__views.__alloyId708);
    ...
    $.__views.__alloyId709.add($.__views.picker);
    var __alloyId710 = [];
    $.__views.__alloyId711 = Ti.UI.createPickerRow({
        title: "All States",
        id: "__alloyId711"
    });
    __alloyId710.push($.__views.__alloyId711);
    $.__views.__alloyId712 = Ti.UI.createPickerRow({
        title: "Selangor",
        id: "__alloyId712"
    });
    __alloyId710.push($.__views.__alloyId712);
    $.__views.__alloyId713 = Ti.UI.createPickerRow({
        title: "Kuala Lumpur",
        id: "__alloyId713"
    });
    __alloyId710.push($.__views.__alloyId713);
    $.__views.__alloyId714 = Ti.UI.createPickerRow({
        title: "Johor",
        id: "__alloyId714"
    });
    __alloyId710.push($.__views.__alloyId714);
    $.__views.picker.add(__alloyId710);
    ...
    $.__views.__alloyId709.add($.__views.__alloyId715);
