...
function Controller() {
    ...
    $.__views.__alloyId222 = Alloy.createController("_header", {
        id: "__alloyId222",
        __parentSymbol: $.__views.domesticCallStatement
    });
    $.__views.__alloyId222.setParent($.__views.domesticCallStatement);
    ...
    back ? $.__views.__alloyId225.addEventListener("click", back) : __defers["$.__views.__alloyId225!click!back"] = true;
    ...
    $.__views.domesticCallStatement.add($.__views.__alloyId226);
    ...
    var __alloyId228 = [];
    $.__views.__alloyId229 = Ti.UI.createTableViewSection({
        id: "__alloyId229"
    });
    ...
    $.__views.__alloyId229.add($.__views.__alloyId237);
    ...
    $.__views.__alloyId229.add($.__views.__alloyId251);
    ...
    $.__views.__alloyId229.add($.__views.__alloyId258);
    ...
    $.__views.__alloyId229.add($.__views.__alloyId265);
    ...
    $.__views.__alloyId229.add($.__views.__alloyId272);
    ...
    $.__views.__alloyId229.add($.__views.__alloyId279);
    ...
    _.extend($, $.__views);
    __defers["$.__views.__alloyId225!click!back"] && $.__views.__alloyId225.addEventListener("click", back);
    _.extend($, exports);
}
