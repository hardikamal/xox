...
function Controller() {
    ...
    $.__views.__alloyId652 = Alloy.createController("_header", {
        id: "__alloyId652",
        __parentSymbol: $.__views.hopOn4
    });
    $.__views.__alloyId652.setParent($.__views.hopOn4);
    ...
    $.__views.hopOn4.add($.__views.__alloyId653);
    ...
    back ? $.__views.__alloyId655.addEventListener("click", back) : __defers["$.__views.__alloyId655!click!back"] = true;
    ...
    $.__views.hopOn4.add($.__views.__alloyId656);
    ...
    $.__views.scrollView.add($.__views.__alloyId659);
    ...
    $.__views.__alloyId659.add($.__views.item_title);
    ...
    $.__views.__alloyId659.add($.__views.desc_title);
    ...
    $.__views.__alloyId659.add($.__views.cost_title);
    ...
    $.__views.__alloyId660.add($.__views.item_data);
    ...
    $.__views.__alloyId660.add($.__views.desc_data);
    ...
    $.__views.__alloyId660.add($.__views.cost_data);
    ...
    $.__views.__alloyId661.add($.__views.total_payment);
    ...
    $.__views.__alloyId661.add($.__views.total_price);
    $.__views.__alloyId662 = Ti.UI.createView({
        height: "50",
        backgroundColor: "red",
        id: "__alloyId662"
    });
    $.__views.hopOn4.add($.__views.__alloyId662);
    submit ? $.__views.__alloyId662.addEventListener("click", submit) : __defers["$.__views.__alloyId662!click!submit"] = true;
    ...
    __defers["$.__views.__alloyId655!click!back"] && $.__views.__alloyId655.addEventListener("click", back);
    __defers["$.__views.__alloyId662!click!submit"] && $.__views.__alloyId662.addEventListener("click", submit);
    _.extend($, exports);
}
