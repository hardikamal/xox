...
function Controller() {
    ...
    $.__views.__alloyId629 = Alloy.createController("_header", {
        id: "__alloyId629",
        __parentSymbol: $.__views.hopOn4
    });
    $.__views.__alloyId629.setParent($.__views.hopOn4);
    ...
    $.__views.hopOn4.add($.__views.__alloyId630);
    ...
    $.__views.__alloyId632 = Ti.UI.createImageView({
        backgroundColor: "transparent",
        width: "30",
        height: "30",
        right: "10",
    ...
    back ? $.__views.__alloyId632.addEventListener("click", back) : __defers["$.__views.__alloyId632!click!back"] = true;
    ...
    $.__views.hopOn4.add($.__views.__alloyId633);
    ...
    $.__views.__alloyId636.add($.__views.item_title);
    ...
    $.__views.__alloyId636.add($.__views.desc_title);
    ...
    $.__views.__alloyId636.add($.__views.cost_title);
    ...
    $.__views.__alloyId637.add($.__views.item_data);
    ...
    $.__views.__alloyId637.add($.__views.desc_data);
    ...
    $.__views.__alloyId637.add($.__views.cost_data);
    ...
    $.__views.__alloyId638.add($.__views.total_payment);
    ...
    $.__views.__alloyId638.add($.__views.total_price);
    ...
    submit ? $.__views.__alloyId639.addEventListener("click", submit) : __defers["$.__views.__alloyId639!click!submit"] = true;
    ...
    __defers["$.__views.__alloyId632!click!back"] && $.__views.__alloyId632.addEventListener("click", back);
    __defers["$.__views.__alloyId639!click!submit"] && $.__views.__alloyId639.addEventListener("click", submit);
    _.extend($, exports);
}
