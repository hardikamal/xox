...
function Controller() {
    ...
    $.__views.__alloyId345 = Alloy.createController("_header", {
        id: "__alloyId345",
        __parentSymbol: $.__views.hopOn4
    });
    $.__views.__alloyId345.setParent($.__views.hopOn4);
    ...
    $.__views.hopOn4.add($.__views.__alloyId346);
    ...
    back ? $.__views.__alloyId348.addEventListener("click", back) : __defers["$.__views.__alloyId348!click!back"] = true;
    ...
    $.__views.hopOn4.add($.__views.__alloyId349);
    ...
    $.__views.__alloyId352.add($.__views.item_title);
    ...
    $.__views.__alloyId352.add($.__views.desc_title);
    ...
    $.__views.__alloyId352.add($.__views.cost_title);
    ...
    $.__views.scrollView.add($.__views.__alloyId353);
    ...
    $.__views.__alloyId353.add($.__views.item_data);
    ...
    $.__views.__alloyId353.add($.__views.desc_data);
    ...
    $.__views.__alloyId353.add($.__views.cost_data);
    ...
    $.__views.scrollView.add($.__views.__alloyId354);
    ...
    $.__views.__alloyId354.add($.__views.total_payment);
    ...
    $.__views.__alloyId354.add($.__views.total_price);
    $.__views.__alloyId355 = Ti.UI.createView({
        height: "50",
        backgroundColor: "red",
        id: "__alloyId355"
    });
    $.__views.hopOn4.add($.__views.__alloyId355);
    submit ? $.__views.__alloyId355.addEventListener("click", submit) : __defers["$.__views.__alloyId355!click!submit"] = true;
    ...
    __defers["$.__views.__alloyId348!click!back"] && $.__views.__alloyId348.addEventListener("click", back);
    __defers["$.__views.__alloyId355!click!submit"] && $.__views.__alloyId355.addEventListener("click", submit);
    _.extend($, exports);
}
