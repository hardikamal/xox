...
function Controller() {
    ...
    $.__views.__alloyId1726 = Alloy.createController("_header", {
        id: "__alloyId1726",
        __parentSymbol: $.__views.prepaidPack
    });
    $.__views.__alloyId1726.setParent($.__views.prepaidPack);
    ...
    $.__views.prepaidPack.add($.__views.__alloyId1727);
    ...
    $.__views.__alloyId1729 = Ti.UI.createImageView({
        backgroundColor: "transparent",
        width: "30",
        height: "30",
        right: "10",
    ...
    back ? $.__views.__alloyId1729.addEventListener("click", back) : __defers["$.__views.__alloyId1729!click!back"] = true;
    ...
    $.__views.prepaidPack.add($.__views.__alloyId1730);
    ...
    $.__views.__alloyId1733.add($.__views.__alloyId1735);
    ...
    $.__views.__alloyId1735.add($.__views.picker);
    var __alloyId1736 = [];
    $.__views.__alloyId1737 = Ti.UI.createPickerRow({
        title: "Standard SIM",
        id: "__alloyId1737"
    });
    __alloyId1736.push($.__views.__alloyId1737);
    $.__views.__alloyId1738 = Ti.UI.createPickerRow({
        title: "Micro SIM",
        id: "__alloyId1738"
    });
    __alloyId1736.push($.__views.__alloyId1738);
    $.__views.__alloyId1739 = Ti.UI.createPickerRow({
        title: "Nano SIM",
        id: "__alloyId1739"
    });
    __alloyId1736.push($.__views.__alloyId1739);
    $.__views.picker.add(__alloyId1736);
    simType ? $.__views.picker.addEventListener("change", simType) : __defers["$.__views.picker!change!simType"] = true;
    $.__views.__alloyId1740 = Ti.UI.createImageView({
    ...
    $.__views.__alloyId1735.add($.__views.__alloyId1740);
    ...
    $.__views.__alloyId1741.add($.__views.__alloyId1743);
    $.__views.switch1 = Ti.UI.createSwitch({
        value: false,
        id: "switch1"
    });
    $.__views.__alloyId1743.add($.__views.switch1);
    ...
    $.__views.scrollView.add($.__views.__alloyId1745);
    ...
    $.__views.__alloyId1748.add($.__views.switch2);
    ...
    $.__views.__alloyId1750.add($.__views.switch3);
    ...
    $.__views.__alloyId1745.add($.__views.__alloyId1752);
    ...
    $.__views.__alloyId1753.add($.__views.switch4);
    ...
    $.__views.__alloyId1755.add($.__views.switch5);
    ...
    $.__views.__alloyId1759 = Ti.UI.createTextField({
        height: "30",
        width: Ti.UI.FILL,
        top: "10",
        borderRadius: "5",
    ...
    $.__views.scrollView.add($.__views.__alloyId1760);
    ...
    $.__views.__alloyId1761.add($.__views.switch6);
    ...
    $.__views.__alloyId1761.add($.__views.switch7);
    ...
    $.__views.scrollView.add($.__views.__alloyId1764);
    ...
    $.__views.__alloyId1765.add($.__views.switch8);
    ...
    $.__views.__alloyId1765.add($.__views.switch9);
    ...
    $.__views.__alloyId1765.add($.__views.__alloyId1767);
    ...
    $.__views.scrollView.add($.__views.__alloyId1768);
    ...
    $.__views.__alloyId1769.add($.__views.switch10);
    ...
    $.__views.__alloyId1769.add($.__views.switch11);
    ...
    $.__views.__alloyId1773.add($.__views.switch12);
    ...
    $.__views.__alloyId1773.add($.__views.switch13);
    ...
    next ? $.__views.__alloyId1776.addEventListener("click", next) : __defers["$.__views.__alloyId1776!click!next"] = true;
    ...
    var simType;
    __defers["$.__views.__alloyId1729!click!back"] && $.__views.__alloyId1729.addEventListener("click", back);
    ...
    __defers["$.__views.__alloyId1776!click!next"] && $.__views.__alloyId1776.addEventListener("click", next);
    _.extend($, exports);
}
