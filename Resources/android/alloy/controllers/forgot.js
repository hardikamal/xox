...
function Controller() {
    ...
    $.__views.__alloyId490.setParent($.__views.forgot);
    ...
    $.__views.forgot.add($.__views.__alloyId491);
    ...
    $.__views.forgot.add($.__views.__alloyId495);
    ...
    submit ? $.__views.__alloyId496.addEventListener("click", submit) : __defers["$.__views.__alloyId496!click!submit"] = true;
    ...
    back ? $.__views.__alloyId499.addEventListener("click", back) : __defers["$.__views.__alloyId499!click!back"] = true;
    ...
    __defers["$.__views.__alloyId496!click!submit"] && $.__views.__alloyId496.addEventListener("click", submit);
    __defers["$.__views.__alloyId499!click!back"] && $.__views.__alloyId499.addEventListener("click", back);
    _.extend($, exports);
}
