...
function Controller() {
    ...
    $.__views.__alloyId521.setParent($.__views.products);
    $.__views.__alloyId522 = Ti.UI.createView({
        height: "20%",
        backgroundColor: "#FBB62D",
        id: "__alloyId522"
    });
    $.__views.products.add($.__views.__alloyId522);
    ...
    $.__views.products.add($.__views.__alloyId524);
    ...
    prepaidPlus ? $.__views.__alloyId525.addEventListener("click", prepaidPlus) : __defers["$.__views.__alloyId525!click!prepaidPlus"] = true;
    ...
    $.__views.__alloyId524.add($.__views.__alloyId529);
    ...
    $.__views.__alloyId524.add($.__views.__alloyId533);
    ...
    $.__views.__alloyId524.add($.__views.__alloyId537);
    ...
    $.__views.__alloyId524.add($.__views.__alloyId541);
    ...
    _.extend($, $.__views);
    __defers["$.__views.__alloyId525!click!prepaidPlus"] && $.__views.__alloyId525.addEventListener("click", prepaidPlus);
