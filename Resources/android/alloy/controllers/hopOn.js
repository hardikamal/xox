...
function Controller() {
    ...
    $.__views.__alloyId253.setParent($.__views.hopOn);
    ...
    $.__views.hopOn.add($.__views.__alloyId254);
    ...
    $.__views.hopOn.add($.__views.__alloyId257);
    ...
    $.__views.scrollView.add($.__views.__alloyId278);
    ...
    $.__views.hopOn.add($.__views.__alloyId280);
    next ? $.__views.__alloyId280.addEventListener("click", next) : __defers["$.__views.__alloyId280!click!next"] = true;
    ...
    __defers["$.__views.__alloyId280!click!next"] && $.__views.__alloyId280.addEventListener("click", next);
    _.extend($, exports);
}
