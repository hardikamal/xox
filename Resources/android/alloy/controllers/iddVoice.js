...
function Controller() {
    ...
    $.__views.__alloyId900.setParent($.__views.iddVoice);
    ...
    $.__views.iddVoice.add($.__views.__alloyId901);
    ...
    $.__views.iddVoice.add($.__views.__alloyId904);
    ...
    var __alloyId906 = [];
    $.__views.__alloyId907 = Ti.UI.createTableViewSection({
        id: "__alloyId907"
    });
    __alloyId906.push($.__views.__alloyId907);
    $.__views.__alloyId908 = Ti.UI.createTableViewRow({
        height: "80",
        width: "100%",
        layout: "horizontal",
        separatorColor: "#000",
    ...
    $.__views.__alloyId908.add($.__views.__alloyId913);
    ...
    $.__views.__alloyId915 = Ti.UI.createTableViewRow({
        height: "80",
        width: "100%",
        layout: "horizontal",
        separatorColor: "#000",
    ...
    $.__views.__alloyId907.add($.__views.__alloyId915);
    ...
    $.__views.__alloyId915.add($.__views.__alloyId918);
    ...
    $.__views.__alloyId915.add($.__views.__alloyId920);
    ...
    $.__views.__alloyId922 = Ti.UI.createTableViewRow({
        height: "80",
        width: "100%",
        layout: "horizontal",
        separatorColor: "#000",
    ...
    $.__views.__alloyId907.add($.__views.__alloyId922);
    ...
    $.__views.__alloyId922.add($.__views.__alloyId925);
    ...
    $.__views.__alloyId922.add($.__views.__alloyId927);
    ...
    $.__views.__alloyId929 = Ti.UI.createTableViewRow({
        height: "80",
        width: "100%",
        layout: "horizontal",
        separatorColor: "#000",
    ...
    $.__views.__alloyId907.add($.__views.__alloyId929);
    ...
    $.__views.__alloyId929.add($.__views.__alloyId934);
    ...
    $.__views.__alloyId936 = Ti.UI.createTableViewRow({
        height: "80",
        width: "100%",
        layout: "horizontal",
        separatorColor: "#000",
    ...
    $.__views.__alloyId907.add($.__views.__alloyId936);
    ...
    $.__views.__alloyId936.add($.__views.__alloyId941);
    ...
    $.__views.__alloyId907.add($.__views.__alloyId943);
    ...
    $.__views.__alloyId907.add($.__views.__alloyId950);
    ...
    $.__views.__alloyId907.add($.__views.__alloyId957);
