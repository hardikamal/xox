...
function Controller() {
    ...
    $.__views.__alloyId1833 = Alloy.createController("_header", {
        id: "__alloyId1833",
        __parentSymbol: $.__views.prepaidPack4
    });
    $.__views.__alloyId1833.setParent($.__views.prepaidPack4);
    ...
    $.__views.prepaidPack4.add($.__views.__alloyId1834);
    ...
    $.__views.prepaidPack4.add($.__views.__alloyId1836);
    ...
    $.__views.__alloyId1839.add($.__views.item_title);
    $.__views.__alloyId1840 = Ti.UI.createButton({
        title: "Done",
        color: "#44C7D6",
        borderColor: "#44C7D6",
        backgroundColor: "white",
    ...
    done ? $.__views.__alloyId1840.addEventListener("click", done) : __defers["$.__views.__alloyId1840!click!done"] = true;
    exports.destroy = function() {};
    _.extend($, $.__views);
    $.scrollView.height = Ti.Platform.displayCaps.platformHeight - 200;
    console.log("android");
    $.scrollView.height = PixelsToDPUnits(Ti.Platform.displayCaps.platformHeight) - 200;
    __defers["$.__views.__alloyId1840!click!done"] && $.__views.__alloyId1840.addEventListener("click", done);
    _.extend($, exports);
}
