...
function Controller() {
    ...
    $.__views.__alloyId552 = Alloy.createController("_header", {
        id: "__alloyId552",
        __parentSymbol: $.__views.promoDetail
    });
    $.__views.__alloyId552.setParent($.__views.promoDetail);
    ...
    $.__views.promoDetail.add($.__views.__alloyId553);
    ...
    $.__views.promoDetail.add($.__views.__alloyId558);
    ...
    $.__views.__alloyId558.add($.__views.__alloyId564);
    $.__views.__alloyId565 = Ti.UI.createView({
        width: "3%",
        id: "__alloyId565"
    });
    $.__views.__alloyId558.add($.__views.__alloyId565);
