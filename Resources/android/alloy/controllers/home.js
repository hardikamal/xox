...
function Controller() {
    ...
    $.__views.__alloyId228 = Alloy.createController("_header", {
        id: "__alloyId228",
        __parentSymbol: $.__views.home
    });
    $.__views.__alloyId228.setParent($.__views.home);
    ...
    $.__views.login.add($.__views.__alloyId229);
    ...
    close ? $.__views.__alloyId231.addEventListener("click", close) : __defers["$.__views.__alloyId231!click!close"] = true;
    ...
    $.__views.__alloyId233.add($.__views.username);
    ...
    $.__views.__alloyId236.add($.__views.password);
    ...
    login ? $.__views.__alloyId239.addEventListener("click", login) : __defers["$.__views.__alloyId239!click!login"] = true;
    $.__views.__alloyId240 = Ti.UI.createView({
        height: "15%",
        width: Ti.UI.FILL,
        id: "__alloyId240"
    });
    $.__views.__alloyId229.add($.__views.__alloyId240);
    ...
    register ? $.__views.__alloyId241.addEventListener("click", register) : __defers["$.__views.__alloyId241!click!register"] = true;
    ...
    myAccount ? $.__views.__alloyId242.addEventListener("click", myAccount) : __defers["$.__views.__alloyId242!click!myAccount"] = true;
    ...
    $.__views.scrollView.add($.__views.__alloyId243);
    ...
    promoNews ? $.__views.__alloyId244.addEventListener("click", promoNews) : __defers["$.__views.__alloyId244!click!promoNews"] = true;
    ...
    product ? $.__views.__alloyId245.addEventListener("click", product) : __defers["$.__views.__alloyId245!click!product"] = true;
    ...
    online ? $.__views.__alloyId247.addEventListener("click", online) : __defers["$.__views.__alloyId247!click!online"] = true;
    ...
    history ? $.__views.__alloyId249.addEventListener("click", history) : __defers["$.__views.__alloyId249!click!history"] = true;
    ...
    contact ? $.__views.__alloyId251.addEventListener("click", contact) : __defers["$.__views.__alloyId251!click!contact"] = true;
    ...
    setting ? $.__views.__alloyId252.addEventListener("click", setting) : __defers["$.__views.__alloyId252!click!setting"] = true;
    ...
    __defers["$.__views.__alloyId231!click!close"] && $.__views.__alloyId231.addEventListener("click", close);
    __defers["$.__views.__alloyId239!click!login"] && $.__views.__alloyId239.addEventListener("click", login);
    __defers["$.__views.__alloyId241!click!register"] && $.__views.__alloyId241.addEventListener("click", register);
    __defers["$.__views.__alloyId242!click!myAccount"] && $.__views.__alloyId242.addEventListener("click", myAccount);
    __defers["$.__views.__alloyId244!click!promoNews"] && $.__views.__alloyId244.addEventListener("click", promoNews);
    __defers["$.__views.__alloyId245!click!product"] && $.__views.__alloyId245.addEventListener("click", product);
    __defers["$.__views.__alloyId247!click!online"] && $.__views.__alloyId247.addEventListener("click", online);
    __defers["$.__views.__alloyId249!click!history"] && $.__views.__alloyId249.addEventListener("click", history);
    __defers["$.__views.__alloyId251!click!contact"] && $.__views.__alloyId251.addEventListener("click", contact);
    __defers["$.__views.__alloyId252!click!setting"] && $.__views.__alloyId252.addEventListener("click", setting);
    _.extend($, exports);
}
