...
function Controller() {
    ...
    $.__views.__alloyId480.setParent($.__views.prepaidPlus);
    ...
    $.__views.prepaidPlus.add($.__views.__alloyId481);
    ...
    $.__views.__alloyId481.add($.__views.__alloyId486);
    back ? $.__views.__alloyId486.addEventListener("click", back) : __defers["$.__views.__alloyId486!click!back"] = true;
    $.__views.__alloyId487 = Ti.UI.createScrollView({
        layout: "vertical",
        backgroundColor: "#E6E7E9",
        width: "90%",
        id: "__alloyId487"
    });
    $.__views.prepaidPlus.add($.__views.__alloyId487);
    ...
    $.__views.__alloyId488.add($.__views.__alloyId494);
    ...
    $.__views.__alloyId487.add($.__views.__alloyId497);
    ...
    $.__views.__alloyId497.add($.__views.__alloyId503);
    ...
    $.__views.__alloyId497.add($.__views.__alloyId506);
    ...
    $.__views.__alloyId497.add($.__views.__alloyId509);
    ...
    $.__views.__alloyId487.add($.__views.__alloyId512);
    ...
    $.__views.__alloyId512.add($.__views.__alloyId518);
    ...
    _.extend($, $.__views);
    __defers["$.__views.__alloyId486!click!back"] && $.__views.__alloyId486.addEventListener("click", back);
    _.extend($, exports);
}
