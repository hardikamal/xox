...
function Controller() {
    ...
    $.__views.__alloyId1142 = Alloy.createController("_header", {
        id: "__alloyId1142",
        __parentSymbol: $.__views.prepaidPack3
    });
    $.__views.__alloyId1142.setParent($.__views.prepaidPack3);
    ...
    $.__views.prepaidPack3.add($.__views.__alloyId1143);
    ...
    back ? $.__views.__alloyId1145.addEventListener("click", back) : __defers["$.__views.__alloyId1145!click!back"] = true;
    ...
    $.__views.prepaidPack3.add($.__views.__alloyId1146);
    ...
    $.__views.__alloyId1149.add($.__views.item_title);
    ...
    $.__views.__alloyId1149.add($.__views.desc_title);
    ...
    $.__views.__alloyId1149.add($.__views.cost_title);
    ...
    $.__views.__alloyId1150.add($.__views.item_data);
    ...
    $.__views.__alloyId1150.add($.__views.desc_data);
    ...
    $.__views.__alloyId1150.add($.__views.cost_data);
    ...
    $.__views.__alloyId1151.add($.__views.item_data);
    $.__views.desc_data = Ti.UI.createLabel({
        font: {
            fontSize: "12dp"
        },
    ...
    $.__views.__alloyId1151.add($.__views.desc_data);
    $.__views.cost_data = Ti.UI.createLabel({
        font: {
            fontSize: "12dp"
        },
    ...
    $.__views.__alloyId1151.add($.__views.cost_data);
    ...
    $.__views.__alloyId1152.add($.__views.item_data);
    $.__views.desc_data = Ti.UI.createLabel({
        font: {
            fontSize: "12dp"
        },
    ...
    $.__views.__alloyId1152.add($.__views.desc_data);
    $.__views.cost_data = Ti.UI.createLabel({
        font: {
            fontSize: "12dp"
        },
    ...
    $.__views.__alloyId1152.add($.__views.cost_data);
    ...
    $.__views.__alloyId1153.add($.__views.item_data);
    $.__views.desc_data = Ti.UI.createLabel({
        font: {
            fontSize: "12dp"
        },
    ...
    $.__views.__alloyId1153.add($.__views.desc_data);
    $.__views.cost_data = Ti.UI.createLabel({
        font: {
            fontSize: "12dp"
        },
    ...
    $.__views.__alloyId1153.add($.__views.cost_data);
    ...
    $.__views.__alloyId1154.add($.__views.total_payment);
    ...
    $.__views.__alloyId1154.add($.__views.total_price);
    $.__views.__alloyId1155 = Ti.UI.createView({
        height: "50",
        backgroundColor: "#4CC4D2",
        id: "__alloyId1155"
    });
    $.__views.prepaidPack3.add($.__views.__alloyId1155);
    submit ? $.__views.__alloyId1155.addEventListener("click", submit) : __defers["$.__views.__alloyId1155!click!submit"] = true;
    ...
    __defers["$.__views.__alloyId1145!click!back"] && $.__views.__alloyId1145.addEventListener("click", back);
    __defers["$.__views.__alloyId1155!click!submit"] && $.__views.__alloyId1155.addEventListener("click", submit);
    _.extend($, exports);
}
