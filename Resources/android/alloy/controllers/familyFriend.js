...
function Controller() {
    ...
    $.__views.__alloyId415.setParent($.__views.familyFriend);
    ...
    $.__views.add.add($.__views.__alloyId416);
    ...
    $.__views.__alloyId419.add($.__views.mobileNo);
    ...
    submit ? $.__views.__alloyId421.addEventListener("click", submit) : __defers["$.__views.__alloyId421!click!submit"] = true;
    ...
    $.__views.__alloyId420.add($.__views.__alloyId424);
    cancel ? $.__views.__alloyId424.addEventListener("click", cancel) : __defers["$.__views.__alloyId424!click!cancel"] = true;
    ...
    $.__views.familyFriend.add($.__views.__alloyId426);
    ...
    back ? $.__views.__alloyId429.addEventListener("click", back) : __defers["$.__views.__alloyId429!click!back"] = true;
    ...
    $.__views.__alloyId426.add($.__views.__alloyId430);
    ...
    $.__views.__alloyId426.add($.__views.scrollView);
    ...
    $.__views.scrollView.add($.__views.__alloyId432);
    ...
    $.__views.scrollView.add($.__views.__alloyId437);
    $.__views.__alloyId438 = Ti.UI.createView({
        height: "50",
        backgroundColor: "black",
        id: "__alloyId438"
    });
    $.__views.__alloyId426.add($.__views.__alloyId438);
    ff ? $.__views.__alloyId438.addEventListener("click", ff) : __defers["$.__views.__alloyId438!click!ff"] = true;
    ...
    __defers["$.__views.__alloyId421!click!submit"] && $.__views.__alloyId421.addEventListener("click", submit);
    __defers["$.__views.__alloyId424!click!cancel"] && $.__views.__alloyId424.addEventListener("click", cancel);
    __defers["$.__views.__alloyId429!click!back"] && $.__views.__alloyId429.addEventListener("click", back);
    __defers["$.__views.__alloyId438!click!ff"] && $.__views.__alloyId438.addEventListener("click", ff);
    _.extend($, exports);
}
