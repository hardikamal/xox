...
function Controller() {
    ...
    $.__views.__alloyId285 = Alloy.createController("_header", {
        id: "__alloyId285",
        __parentSymbol: $.__views.domesticSMS
    });
    $.__views.__alloyId285.setParent($.__views.domesticSMS);
    ...
    $.__views.domesticSMS.add($.__views.__alloyId286);
    ...
    $.__views.domesticSMS.add($.__views.__alloyId289);
    ...
    var __alloyId291 = [];
    $.__views.__alloyId292 = Ti.UI.createTableViewSection({
        id: "__alloyId292"
    });
    ...
    $.__views.__alloyId292.add($.__views.__alloyId300);
    ...
    $.__views.__alloyId292.add($.__views.__alloyId307);
    ...
    $.__views.__alloyId292.add($.__views.__alloyId314);
    ...
    $.__views.__alloyId292.add($.__views.__alloyId321);
    ...
    $.__views.__alloyId328 = Ti.UI.createTableViewRow({
        height: "80",
        width: "100%",
        layout: "horizontal",
        separatorColor: "#000",
    ...
    $.__views.__alloyId292.add($.__views.__alloyId328);
    ...
    $.__views.__alloyId335 = Ti.UI.createTableViewRow({
        height: "80",
        width: "100%",
        layout: "horizontal",
        separatorColor: "#000",
    ...
    $.__views.__alloyId292.add($.__views.__alloyId335);
    ...
    $.__views.__alloyId342 = Ti.UI.createTableViewRow({
        height: "80",
        width: "100%",
        layout: "horizontal",
        separatorColor: "#000",
    ...
    $.__views.__alloyId292.add($.__views.__alloyId342);
