...
function Controller() {
    ...
    $.__views.__alloyId350 = Alloy.createController("_header", {
        id: "__alloyId350",
        __parentSymbol: $.__views.domesticVideo
    });
    $.__views.__alloyId350.setParent($.__views.domesticVideo);
    ...
    $.__views.domesticVideo.add($.__views.__alloyId351);
    ...
    back ? $.__views.__alloyId353.addEventListener("click", back) : __defers["$.__views.__alloyId353!click!back"] = true;
    ...
    $.__views.domesticVideo.add($.__views.__alloyId354);
    ...
    var __alloyId356 = [];
    $.__views.__alloyId357 = Ti.UI.createTableViewSection({
        id: "__alloyId357"
    });
    ...
    $.__views.__alloyId357.add($.__views.__alloyId365);
    ...
    $.__views.__alloyId357.add($.__views.__alloyId372);
    ...
    $.__views.__alloyId357.add($.__views.__alloyId379);
    ...
    $.__views.__alloyId357.add($.__views.__alloyId386);
    ...
    $.__views.__alloyId393 = Ti.UI.createTableViewRow({
        height: "80",
        width: "100%",
        layout: "horizontal",
        separatorColor: "#000",
    ...
    $.__views.__alloyId357.add($.__views.__alloyId393);
    ...
    $.__views.__alloyId400 = Ti.UI.createTableViewRow({
        height: "80",
        width: "100%",
        layout: "horizontal",
        separatorColor: "#000",
    ...
    $.__views.__alloyId357.add($.__views.__alloyId400);
    ...
    $.__views.__alloyId400.add($.__views.__alloyId405);
    ...
    $.__views.__alloyId407 = Ti.UI.createTableViewRow({
        height: "80",
        width: "100%",
        layout: "horizontal",
        separatorColor: "#000",
    ...
    $.__views.__alloyId357.add($.__views.__alloyId407);
    ...
    $.__views.__alloyId407.add($.__views.__alloyId412);
    ...
    _.extend($, $.__views);
    __defers["$.__views.__alloyId353!click!back"] && $.__views.__alloyId353.addEventListener("click", back);
    _.extend($, exports);
}
