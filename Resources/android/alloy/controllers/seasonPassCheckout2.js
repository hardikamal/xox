...
function Controller() {
    ...
    $.__views.__alloyId2299 = Alloy.createController("_header", {
        id: "__alloyId2299",
        __parentSymbol: $.__views.seasonPassCheckout2
    });
    $.__views.__alloyId2299.setParent($.__views.seasonPassCheckout2);
    ...
    $.__views.seasonPassCheckout2.add($.__views.__alloyId2300);
    ...
    back ? $.__views.__alloyId2302.addEventListener("click", back) : __defers["$.__views.__alloyId2302!click!back"] = true;
    $.__views.__alloyId2303 = Ti.UI.createView({
        layout: "vertical",
        height: "100",
        id: "__alloyId2303"
    });
    $.__views.seasonPassCheckout2.add($.__views.__alloyId2303);
    ...
    $.__views.__alloyId2303.add($.__views.__alloyId2305);
    ...
    $.__views.__alloyId2305.add($.__views.picker);
    var __alloyId2306 = [];
    $.__views.__alloyId2307 = Ti.UI.createPickerRow({
        title: "All States",
        id: "__alloyId2307"
    });
    __alloyId2306.push($.__views.__alloyId2307);
    $.__views.__alloyId2308 = Ti.UI.createPickerRow({
        title: "Selangor",
        id: "__alloyId2308"
    });
    __alloyId2306.push($.__views.__alloyId2308);
    $.__views.__alloyId2309 = Ti.UI.createPickerRow({
        title: "Kuala Lumpur",
        id: "__alloyId2309"
    });
    __alloyId2306.push($.__views.__alloyId2309);
    $.__views.__alloyId2310 = Ti.UI.createPickerRow({
        title: "Johor",
        id: "__alloyId2310"
    });
    __alloyId2306.push($.__views.__alloyId2310);
    $.__views.picker.add(__alloyId2306);
    method ? $.__views.picker.addEventListener("change", method) : __defers["$.__views.picker!change!method"] = true;
    $.__views.__alloyId2311 = Ti.UI.createImageView({
    ...
    $.__views.__alloyId2305.add($.__views.__alloyId2311);
    ...
    $.__views.scrollView.add($.__views.__alloyId2312);
    ...
    tac ? $.__views.__alloyId2313.addEventListener("click", tac) : __defers["$.__views.__alloyId2313!click!tac"] = true;
    ...
    verify ? $.__views.__alloyId2316.addEventListener("click", verify) : __defers["$.__views.__alloyId2316!click!verify"] = true;
    ...
    __defers["$.__views.__alloyId2302!click!back"] && $.__views.__alloyId2302.addEventListener("click", back);
    __defers["$.__views.picker!change!method"] && $.__views.picker.addEventListener("change", method);
    __defers["$.__views.__alloyId2313!click!tac"] && $.__views.__alloyId2313.addEventListener("click", tac);
    __defers["$.__views.__alloyId2316!click!verify"] && $.__views.__alloyId2316.addEventListener("click", verify);
    _.extend($, exports);
}
