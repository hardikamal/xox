...
// in simulator we redefine to format for XOX Developer console
...
{\
	NSString * exceptionName = [@"org.xox." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.xox";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIXOXNativeItemNone = -1, 
	UIXOXNativeItemSpinner = -2,
	UIXOXNativeItemProgressBar = -3,
	
	UIXOXNativeItemSlider = -4,
	UIXOXNativeItemSwitch = -5,
	UIXOXNativeItemMultiButton = -6,
	UIXOXNativeItemSegmented = -7,
	
	UIXOXNativeItemTextView = -8,
	UIXOXNativeItemTextField = -9,
	UIXOXNativeItemSearchBar = -10,
	
	UIXOXNativeItemPicker = -11,
	UIXOXNativeItemDatePicker = -12,
	
	UIXOXNativeItemInfoLight = -13,
	UIXOXNativeItemInfoDark = -14,
	
	UIXOXNativeItemDisclosure = -15,
	
	UIXOXNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all XOX instances of
